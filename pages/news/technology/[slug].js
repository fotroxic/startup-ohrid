  ...
  return (
    ...
    <h3 className='news__text__details'>{frontmatter.category}</h3>
      ...
      <div className='social__medias'>
        <a target="blank" href={`${frontmatter.facebook}`}><img className='social__media__logos' src='https://cdn-icons-png.flaticon.com/512/124/124010.png'></img></a>
        <a target="blank" href={`${frontmatter.linkedin}`}><img className='social__media__logos' src='https://pbs.twimg.com/profile_images/1661161645857710081/6WtDIesg_400x400.png'></img></a>
        <a target="blank" href={`${frontmatter.twitter}`}><img className='social__media__logos' src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/6f/Logo_of_Twitter.svg/292px-Logo_of_Twitter.svg.png'></img></a>
